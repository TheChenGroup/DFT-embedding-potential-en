...
isFristOEP = False             # Whether it is the first DMFET calculation for this system (whether Vemb is inherited), True means it is the first time, subsequent calculations are all False
...
total_smear_sigma = 0.005        # Gaussian smearing width for the entire system, set to 0 if no smearing
a_smear_sigma = 0.005            # Gaussian smearing width for the "embedding region"
b_smear_sigma = 0.005            # Gaussian smearing width for the "environment"
